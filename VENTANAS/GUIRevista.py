...
# Form implementation generated from reading ui file 'GUIRevista.ui'
#
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.tabla_revistas = QtWidgets.QTableWidget(self.tab_1)
        self.tabla_revistas.setGeometry(QtCore.QRect(30, 20, 311, 331))
        self.tabla_revistas.setRowCount(0)
        self.tabla_revistas.setColumnCount(3)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.tipoA = QtWidgets.QLineEdit(self.layoutWidget)
        self.tipoA.setObjectName("tipoA")
        self.verticalLayout.addWidget(self.tipoA)
        self.contador_revistaA = QtWidgets.QLineEdit(self.layoutWidget)
        self.contador_revistaA.setObjectName("contador_revistaA")
        self.verticalLayout.addWidget(self.contador_revistaA)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.id_revista = QtWidgets.QLineEdit(self.tab_3)
        self.id_revista.setGeometry(QtCore.QRect(50, 140, 180, 20))
        self.id_revista.setObjectName("id_revista")
        ...
        self.tipo_actualizar = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.tipo_actualizar.setObjectName("tipo_actualizar")
        self.verticalLayout_4.addWidget(self.tipo_actualizar)
        self.contador_revista_actualizar = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.contador_revista_actualizar.setObjectName("contador_revista_actualizar")
        self.verticalLayout_4.addWidget(self.contador_revista_actualizar)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "REGISTRO DE REVISTAS"))
        ...
        item.setText(_translate("Form", "Contador Revista"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_1), _translate("Form", "REVISTAS"))
        ...
        self.label_4.setText(_translate("Form", "CONTADOR REVISTA:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Form", "AGREGAR NUEVAS REVISTAS"))
        ...
        self.label_7.setText(_translate("Form", "CONTADOR REVISTA:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Form", "ACTUALIZAR REVISTAS"))
        ...
        item.setText(_translate("Form", "Contador Revista"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("Form", "BORRAR REVISTAS"))
